        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const faqData = [
                ...
                },
                {
                    ...
                    answer: "I am Sundar Maity, I am in Final year in Diploma in CSE from BRAINWARE UNIVERSITY.Know more in my CV.",
                    mainLink: {
                        text: "My CV",
                    ...
                    supporting: {
                        question: "My Skills",
                        answer: "My skills are HTML and CSS, I have some knowledge in JavaScript and Python, use Ai tools. My projects are based on HTML,CSS also some of Java Script.",
                        
                    },
                    supporting: {
                        question: "My Hobby",
                        answer: "My hobbis are playing cricket, watching movies,reading book, and listening to music and Storys.",
                        
                    }
                },
                {
                    question: "My Strength",
                    answer: "I am a quick learner and a good team player. I can work under pressure and meet deadlines.I am punctual, also have leadership ability.",
            ...
            function buildHelpCenter() {
                ...
                faqData.forEach(item => {
                    ...
                    if (item.supporting) {
                        ...
                        let linkHtml = '';
                        if (item.supporting.link && item.supporting.link.text && item.supporting.link.href) {
                            linkHtml = `
            ...
            function attachAccordionListeners() {
                ...
                const accordions = document.querySelectorAll(".faq-container .faq-question");
